...
export type HorseRace = {
  ...
  instructions: [
    {
      name: 'runCancelBet';
      docs: ['Cancel a Bet'];
      discriminator: [154, 97, 164, 238, 225, 178, 79, 134];
      accounts: [
        {
          name: 'user';
          writable: true;
    ...
    },
    {
      name: 'runCreateBet';
      docs: ['Create a Bet'];
      discriminator: [83, 62, 238, 252, 115, 109, 59, 27];
      accounts: [
        {
          name: 'user';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [85, 21, 141, 208, 23, 187, 111, 68];
      accounts: [
        {
          name: 'authority';
          writable: true;
    ...
    },
    {
      name: 'runCreatePool';
      docs: ['Create a Pool'];
      discriminator: [225, 56, 189, 2, 220, 61, 209, 12];
      accounts: [
        {
          name: 'authority';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [200, 65, 121, 126, 37, 233, 200, 41];
      accounts: [
        {
          name: 'authority';
          writable: true;
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [112, 111, 111, 108, 95, 111, 114, 97, 99, 108, 101];
              },
              {
                kind: 'arg';
                path: 'pool';
    ...
    },
    {
      ...
      docs: ['Settle a Pool'];
      discriminator: [171, 89, 52, 200, 177, 251, 136, 83];
      accounts: [
        {
          name: 'authority';
          writable: true;
    ...
    },
    {
      ...
      discriminator: [210, 126, 133, 97, 83, 143, 202, 83];
      accounts: [
        {
          name: 'competition';
          writable: true;
    ...
    },
    {
      ...
      docs: ['Update a Pool Price Feed'];
      discriminator: [231, 14, 29, 101, 113, 15, 145, 140];
      accounts: [
        {
          name: 'authority';
          writable: true;
  ...
  accounts: [
    ...
    },
    {
      ...
      discriminator: [165, 246, 143, 134, 31, 187, 230, 30];
    },
    {
      name: 'priceUpdateV2';
