...
async function updateCompetitionInstruction(program, competitionPubkey, tokenA, priceFeedId, adminPubkeys, houseCutFactor, minPayoutRatio, interval, startTime, endTime) {
